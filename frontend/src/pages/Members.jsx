...
const Members = () => {
  ...
  const checkAuthAndLoadData = useCallback(async () => {
    ...
    try {
      // Get membership info
      const membershipRes = await fetch(`${API}/api/membership/user/${userId}`, {
  ...
  const getMembershipBadge = () => {
    ...
    return (
      <span className={`px-3 py-1 rounded-full text-sm font-medium ${badgeColors[membershipInfo.plan]}`}>
        {membershipInfo.plan === 'lifetime' && <FaCrown className="inline mr-1" />}
  ...
  const getVideoEmbedUrl = (youtubeUrl) => {
    const videoId = youtubeUrl.match(/(?:youtube\.com\/(?:[^/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?/\s]{11})/i);
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  {getMembershipBadge()}
                  {membershipInfo?.expiry && membershipInfo.plan !== 'lifetime' && (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-primary to-darkblue rounded-2xl p-8 text-white mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h2 className="text-3xl font-bold">Welcome to Your Learning Hub</h2>
              <p className="text-white/80 mt-2">
                Access exclusive content tailored to your {membershipInfo?.plan} membership
              </p>
            </div>
          </div>
        ...
        {/* Videos Section */}
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Exclusive Video Content</h3>
          ...
          {videos.length === 0 ? (
            <div className="bg-white rounded-2xl p-8 text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">No Videos Available</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videos.map((video) => (
                <div key={video._id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Your Membership Benefits</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Exclusive Videos</h4>
                <p className="text-gray-600 text-sm">Access to premium video content and tutorials</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Advanced courses and specialized training materials</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Community Access</h4>
                <p className="text-gray-600 text-sm">Connect with fellow members and mentors</p>
              </div>
            </div>
          </div>
        </div>
